...
public abstract class Elem2Elem {
  ...
  protected final Containers2MiniYAML trafo;
  ...
  private static final ContainersPackage sourcePackage = ContainersPackage.eINSTANCE;

  private static final MiniyamlPackage targetPackage = MiniyamlPackage.eINSTANCE;

  private static final ContainersFactory sourceFactory = ContainersFactory.eINSTANCE;

  private static final MiniyamlFactory targetFactory = MiniyamlFactory.eINSTANCE;

  private static final CorrModelFactory corrFactory = CorrModelFactory.eINSTANCE;

  public static Map<EObject, Corr> elementsToCorr = CollectionLiterals.<EObject, Corr>newHashMap();

  public Elem2Elem(final String ruleId, final Containers2MiniYAML trafo) {
    this.ruleId = ruleId;
    this.trafo = trafo;
